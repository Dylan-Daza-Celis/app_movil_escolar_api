...
class Evento(models.Model):
    ...
    nombre_responsable = models.CharField(max_length=255, null=True, blank=True)
    tipo = models.CharField(max_length=255, null=True, blank=True)
    numero_participantes = models.IntegerField(null=True, blank=True)
    programa_educativo = models.CharField(max_length=255, null=True, blank=True)
    
    def __str__(self):
        return "Perfil del evento " + self.nombre + " " + self.nombre_responsable